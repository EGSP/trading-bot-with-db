export function formatMessage(query : string, obj : any) {
    let res = "";
...
function format_getbank(obj : any) : string {
...
function format_getstats(obj : any) : string {
...
function format_get_ticker_stat(obj : any) : string {
...
function format_get_pnl(obj : any) : string {
    return `<b>\$</b><i>${obj}</i>`;
}

function format_get_bank_real(obj : any) : string {
...
function format_active_trades(obj : any) {
    if(obj.length === 0)
